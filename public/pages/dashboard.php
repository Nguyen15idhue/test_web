...
// Base URL configuration (Consider moving this to a central config file if used elsewhere)
$protocol = isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://";
$domain = $_SERVER['HTTP_HOST'];
// Assuming the public directory is the web root or accessed directly
$base_url = $protocol . $domain; // Adjust if your setup is different
...
if (!isset($_SESSION['user_id'])) {
    ...
    header('Location: ' . $base_url . '/pages/login.php'); // Adjust path if login is elsewhere
    exit;
}
